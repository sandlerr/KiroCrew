...
class DashboardState:
    ...
    def __init__(
        ...
        # and sets it once the pass has settled; that function's middleware
        # holds every mutating ``/api/`` request on it, so no session can bind
        # an agent between the prune's history check of a candidate and its
